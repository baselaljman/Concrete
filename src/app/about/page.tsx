        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl ml-auto">
            ...
            <p className="text-lg md:text-xl opacity-80 leading-relaxed">
              {language === 'ar' 
                ? 'نحن في أعمال الخرسانه الجاهزه نؤمن بأن القوة تبدأ من الأساس. نقدم حلولاً خرسانية مسبقة الصنع تجمع بين المتانة الهندسية والجمال المعماري.'
                : 'At Ready Mix Concrete Works, we believe strength starts from the foundation. We provide precast concrete solutions combining engineering durability with architectural beauty.'}
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 relative aspect-video lg:aspect-square rounded-3xl overflow-hidden shadow-2xl">
            <Image src={qualityImg} alt="جودة أعمال الخرسانه الجاهزه" fill className="object-cover" />
          </div>
          <div className="order-1 lg:order-2 space-y-6">
            <h2 className="text-3xl font-headline font-bold text-primary">قصة التميز</h2>
            <p className="text-muted-foreground leading-relaxed">
              تأسست أعمال الخرسانه الجاهزه لتلبية الطلب المتزايد على المنتجات الخرسانية عالية الجودة في السوق السعودي. ومنذ البداية، ركزنا على الاستثمار في أفضل القوالب والمعدات لضمان أعلى معايير الجودة.
            </p>
            <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="bg-primary rounded-[3rem] p-8 md:p-16 text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-video rounded-2xl overflow-hidden border-8 border-white/10 shadow-2xl">
              <Image src={factoryImg} alt="مصنع أعمال الخرسانه الجاهزه" fill className="object-cover" />
            </div>
          </div>
        </div>
      </section>
