'use server';
/**
 * @fileOverview An AI-powered chatbot for Concreate Solutions, providing answers to customer inquiries.
 *
...
const companyDescription = `نقدم لكم الحلول الخرسانية المتكاملة لمشاريعكم بكفاءة وجودة عالية. نحن لا نقتصر على البيع فحسب، بل نضمن لكم تجربة مميزة تبدأ من اختيار المنتج المناسب وحتى التوصيل إلى موقعكم بكل سهولة وأمان .
لماذا نحن مختلفون؟
\t•\tتنوع هائل: جميع أنواع القواعد الخرسانية لأعمدة الإنارة ، المناهل الارضية للصرف الصحي وتمديدات الكهرباء، الحواجز الخرسانية، الحواجز الامنية، أحواض الزهور، 
كراسي تجميلية للحدائق والطرقات،المصدات الأرضية للسيارات، يتوفر لدينا جميع الانواع و المقاسات حسب الطلب .
...
في نهدف لأن نكون شريككم الموثوق في كل مشروع، ونوفر لكم جميع المنتجات الخرسانية و جودة اعتمادية التي تبحثون عنها، مع تجربة شراء سلسة ومميزة.`;
...
const aiChatbotSupportPrompt = ai.definePrompt({
  ...
  system: `أنت روبوت محادثة ذكي لـ "Concreate Solutions". مهمتك هي الإجابة على أسئلة العملاء حول منتجاتنا وخدماتنا.
...
معلومات عن "Concreate Solutions":
${companyDescription}
`,
