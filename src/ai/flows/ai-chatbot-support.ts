...
'use server';
/**
 * @fileOverview An AI-powered chatbot for Road Standards for Precast Co., providing answers to customer inquiries.
 *
...
const companyDescription = `نقدم لكم الحلول الخرسانية المتكاملة لمشاريعكم بكفاءة وجودة عالية في "شركة معايير الطرق للبريكاست". نحن لا نقتصر على البيع فحسب، بل نضمن لكم تجربة مميزة تبدأ من اختيار المنتج المناسب وحتى التوصيل إلى موقعكم بكل سهولة وأمان.
لماذا نحن مختلفون؟
...
نحن في شركة معايير الطرق للبريكاست نهدف لأن نكون شريككم الموثوق في كل مشروع، ونوفر لكم جميع المنتجات الخرسانية والجودة الاعتمادية التي تبحثون عنها.`;
...
const aiChatbotSupportPrompt = ai.definePrompt({
  ...
  system: `أنت روبوت محادثة ذكي لـ "شركة معايير الطرق للبريكاست". مهمتك هي الإجابة على أسئلة العملاء حول منتجاتنا وخدماتنا.
...
معلومات عن "شركة معايير الطرق للبريكاست":
${companyDescription}
`,
