'use server';
/**
 * @fileOverview An AI-powered chatbot for Ready Mix Concrete Works, providing answers to customer inquiries.
 *
...
const companyDescription = `نقدم لكم الحلول الخرسانية المتكاملة لمشاريعكم بكفاءة وجودة عالية في "أعمال الخرسانه الجاهزه". نحن لا نقتصر على البيع فحسب، بل نضمن لكم تجربة مميزة تبدأ من اختيار المنتج المناسب وحتى التوصيل إلى موقعكم بكل سهولة وأمان.
لماذا نحن مختلفون؟
...
نحن في أعمال الخرسانه الجاهزه نهدف لأن نكون شريككم الموثوق في كل مشروع، ونوفر لكم جميع المنتجات الخرسانية والجودة الاعتمادية التي تبحثون عنها.`;
...
const aiChatbotSupportPrompt = ai.definePrompt({
  ...
  system: `أنت روبوت محادثة ذكي لـ "أعمال الخرسانه الجاهزه". مهمتك هي الإجابة على أسئلة العملاء حول منتجاتنا وخدماتنا.
...
معلومات عن "أعمال الخرسانه الجاهزه":
${companyDescription}
`,
