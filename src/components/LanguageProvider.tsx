...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    brand_name: 'الفرات',
    brand_full_name: 'الفرات للأعمال الخرسانية',
    hero_title: 'نبني القوة،',
    hero_subtitle: 'نشكل التقدم',
    hero_desc: 'حلول خرسانية متميزة من الفرات للإنارة، سلامة الطرق، والتطوير الحضري. صُممت لتدوم، وسُلمت بدقة.',
    ...
    footer_desc: 'نقدم حلولاً خرسانية متكاملة لمشاريعكم بكفاءة وجودة عالية في الفرات للأعمال الخرسانية. نحن نضمن تجربة فريدة من اختيار المنتج إلى التسليم من خلال فريق هندسي متخصص.',
    footer_quick_links: 'روابط سريعة',
    footer_categories: 'الفئات',
    footer_contact_us: 'اتصل بنا',
    footer_rights: 'جميع الحقوق محفوظة - الفرات للأعمال الخرسانية',
    ...
    bot_welcome: 'مرحباً بك في الفرات. كيف يمكننا مساعدتك اليوم في مشروعك الخرساني؟',
    bot_title: 'الدعم الفني للفرات',
  ...
  en: {
    ...
    brand_name: 'Al Furat',
    brand_full_name: 'Al Furat for Concrete Works',
    hero_title: 'Building Strength,',
    hero_subtitle: 'Shaping Progress',
    hero_desc: 'Premium concrete solutions from Al Furat for lighting, road safety, and urban development. Built to last, delivered with precision.',
    ...
    footer_desc: 'We provide integrated concrete solutions for your projects with high efficiency and quality at Al Furat Concrete Works. We guarantee a unique experience with an expert engineering team.',
    footer_quick_links: 'Quick Links',
    footer_categories: 'Categories',
    footer_contact_us: 'Contact Us',
    footer_rights: 'All rights reserved - Al Furat for Concrete Works',
    ...
    bot_welcome: 'Welcome to Al Furat. How can we help you with your concrete project today?',
    bot_title: 'Al Furat Support',
