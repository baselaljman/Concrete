...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    brand_name: 'الخرسانه الجاهزه',
    brand_full_name: 'أعمال الخرسانه الجاهزه',
    hero_title: 'نبني القوة،',
    hero_subtitle: 'نشكل التقدم',
    hero_desc: 'حلول خرسانية متميزة من أعمال الخرسانه الجاهزه للإنارة، سلامة الطرق، والتطوير الحضري. صُممت لتدوم، وسُلمت بدقة.',
    ...
    footer_desc: 'نقدم حلولاً خرسانية متكاملة لمشاريعكم بكفاءة وجودة عالية في أعمال الخرسانه الجاهزه. نحن نضمن تجربة فريدة من اختيار المنتج إلى التسليم من خلال فريق هندسي متخصص.',
    footer_quick_links: 'روابط سريعة',
    footer_categories: 'الفئات',
    footer_contact_us: 'اتصل بنا',
    footer_rights: 'جميع الحقوق محفوظة - أعمال الخرسانه الجاهزه',
    ...
    bot_welcome: 'مرحباً بك في أعمال الخرسانه الجاهزه. كيف يمكننا مساعدتك اليوم في مشروعك الخرساني؟',
    bot_title: 'دعم الخرسانه الجاهزه',
  ...
  en: {
    ...
    brand_name: 'Ready Mix',
    brand_full_name: 'Ready Mix Concrete Works',
    hero_title: 'Building Strength,',
    hero_subtitle: 'Shaping Progress',
    hero_desc: 'Premium concrete solutions from Ready Mix Concrete Works for lighting, road safety, and urban development. Built to last, delivered with precision.',
    ...
    footer_desc: 'We provide integrated concrete solutions for your projects with high efficiency and quality at Ready Mix Concrete Works. We guarantee a unique experience with an expert engineering team.',
    footer_quick_links: 'Quick Links',
    footer_categories: 'Categories',
    footer_contact_us: 'Contact Us',
    footer_rights: 'All rights reserved - Ready Mix Concrete Works.',
    ...
    bot_welcome: 'Welcome to Ready Mix Concrete Works. How can we help you with your concrete project today?',
    bot_title: 'Ready Mix Support',
