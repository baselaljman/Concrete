...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    brand_name: 'شركة الأعمال الخرسانية',
    brand_full_name: 'شركة للأعمال والحلول الخرسانية',
    ...
    footer_rights: 'جميع الحقوق محفوظة - شركة للأعمال والحلول الخرسانية',
  ...
  en: {
    ...
    brand_full_name: 'Concrete Works & Solutions Co.',
    ...
    footer_rights: 'All rights reserved - Concrete Works & Solutions Co.',
