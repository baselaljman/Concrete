...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    brand_name: 'معايير الطرق',
    brand_full_name: 'شركة معايير الطرق للبريكاست',
    hero_title: 'نبني القوة،',
    hero_subtitle: 'نشكل التقدم',
    hero_desc: 'حلول خرسانية متميزة من معايير الطرق للإنارة، سلامة الطرق، والتطوير الحضري. صُممت لتدوم، وسُلمت بدقة.',
    ...
    footer_desc: 'نقدم حلولاً خرسانية متكاملة لمشاريعكم بكفاءة وجودة عالية في شركة معايير الطرق للبريكاست. نحن نضمن تجربة فريدة من اختيار المنتج إلى التسليم من خلال فريق هندسي متخصص.',
    footer_quick_links: 'روابط سريعة',
    footer_categories: 'الفئات',
    footer_contact_us: 'اتصل بنا',
    footer_rights: 'جميع الحقوق محفوظة - شركة معايير الطرق للبريكاست',
    ...
    bot_welcome: 'مرحباً بك في معايير الطرق للبريكاست. كيف يمكننا مساعدتك اليوم في مشروعك الخرساني؟',
    bot_title: 'دعم معايير الطرق',
  ...
  en: {
    ...
    brand_name: 'Road Standards',
    brand_full_name: 'Road Standards for Precast Company',
    hero_title: 'Building Strength,',
    hero_subtitle: 'Shaping Progress',
    hero_desc: 'Premium concrete solutions from Road Standards for lighting, road safety, and urban development. Built to last, delivered with precision.',
    ...
    footer_desc: 'We provide integrated concrete solutions for your projects with high efficiency and quality at Road Standards for Precast. We guarantee a unique experience with an expert engineering team.',
    footer_quick_links: 'Quick Links',
    footer_categories: 'Categories',
    footer_contact_us: 'Contact Us',
    footer_rights: 'All rights reserved - Road Standards for Precast Co.',
    ...
    bot_welcome: 'Welcome to Road Standards for Precast. How can we help you with your concrete project today?',
    bot_title: 'Road Standards Support',
